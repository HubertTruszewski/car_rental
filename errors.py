class WrongDbIdTypeError(TypeError):
    pass


class NegativeDbIdError(ValueError):
    pass
...
class WrongSeatsTypeError(TypeError):
    pass


class WrongFuelConsumptionTypeError(TypeError):
    pass
...
class WrongDoorsTypeError(TypeError):
    pass
